"""
Train a final XGBoost model on all available data and generate predictions
for every NTA × month in the modeling table.

Use this for dashboard serving and future inference.
...
def predict(model: xgb.XGBRegressor, df: pd.DataFrame) -> pd.DataFrame:
